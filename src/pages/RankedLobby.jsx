          ...
          <div className="text-center md:text-left space-y-6">
            ...
            <div className="pt-8 space-y-4">
              <button
                ...
                className={`group relative px-8 py-5 w-full md:w-auto bg-base-content text-base-dark font-bold text-xl rounded-none clip-path-slant overflow-hidden transition-all hover:scale-105`}
